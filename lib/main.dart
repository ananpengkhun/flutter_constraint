...
class Button extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialButton(
        color: isSelected == true ? Colors.grey : Colors.grey[800],
...
Widget getConstraint(Widget child){
  return LayoutBuilder(builder: (context, constrain){
    debugPrint("getConstraint minWidth :${constrain.minWidth}");
    debugPrint("getConstraint maxWidth :${constrain.maxWidth}");
    debugPrint("getConstraint minHeight :${constrain.minHeight}");
    debugPrint("getConstraint maxHeight :${constrain.maxHeight}");
    return child;
  });
}
...
class Example2 extends Example {
  ...
  @override
  Widget build(BuildContext context) {
    return getConstraint(Container(width: 100, height: 100, color: red));
...
class Example3 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: getConstraint(Container(width: 100, height: 100, color: red)),
    );
  }
}
...
class Example7 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
        color: red,
        child: getConstraint( Container(color: green, width: 30, height: 30)),
      ),
    );
  }
}
...
class Example9 extends Example {
  ...
  Widget build(BuildContext context) {
    return getConstraint(
       ConstrainedBox(
          constraints: BoxConstraints(minWidth: 70, minHeight: 70, maxWidth: 150, maxHeight: 200),
          child: getConstraint( Container(color: red, width: 10, height: 10)),
        ),
    );
  }
}
...
class Example13 extends Example {
  ...
  Widget build(BuildContext context) {
    return getConstraint(
       UnconstrainedBox(
        child: getConstraint(Container(color: red, width: 20, height: 50)),
      ),
    );
  }
}
...
class Example18 extends Example {
  ...
  Widget build(BuildContext context) {
    return getConstraint(
       FittedBox(
        child: Text("Some Example Texascsacascasct."),
      ),
    );
  }
}
    ...
    return Row(
      children: [
        Flexible(
            child: Container(
                color: red,
                child: Text("This is a ", style: big))),
        Flexible(
          fit: FlexFit.tight,
